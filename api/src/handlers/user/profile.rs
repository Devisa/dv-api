...
use api_common::models::{Model, Profile, verification::VerificationRequest};
...
#[get("/{profile_id}")]
pub async fn get_by_id(req: HttpRequest, db: Data<Db>, profile_id: Path<Uuid>) -> impl Responder {
...
#[delete("/{profile_id}")]
pub async fn delete_by_id(req: HttpRequest, db: Data<Db>, profile_id: Path<Uuid>) -> impl Responder {
...
#[get("/user/{user_id}")]
pub async fn get_by_user_id(req: HttpRequest, db: Data<Db>, user_id: Path<Uuid>) -> impl Responder {
