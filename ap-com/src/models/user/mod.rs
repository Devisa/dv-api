...
use crate::{
    ...
    models::{
        ...
        messages::user::DirectUserMessage,
    }
};
use sqlx::{
...
impl User {
    ...
    #[inline]
    pub fn new(email: &str, name: Option<&str>, image: Option<&str>) -> Self {
        User {
    ...
    /// Generate a new user with random name, email, etc.
    #[inline(always)]
    pub fn gen() -> Self {
    ...
    /// Fetch user from DB with the username provided by fetching credentials, then user
